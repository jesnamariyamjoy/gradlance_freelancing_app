...
import 'chat_screen.dart'; // Import the ChatScreen code provided earlier
    ...
    while (true) {
      ...
      try {
        final data = await supabase
            .from('tbl_chat')
            .select()
            .or('from_userid.eq.$currentUserId,to_userid.eq.$currentUserId,from_clientid.eq.$currentUserId,to_clientid.eq.$currentUserId')
