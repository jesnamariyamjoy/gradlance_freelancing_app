...
class _SubscriptionPageState extends State<SubscriptionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    const brandBlue = Color(0xFF2196F3);
              ...
              child: Column(
                ...
                children: [
                  if (currentSubscription != null) ...[
                    _buildCurrentPlanCard(currentSubscription!, brandBlue),
                  ...
                  Text(
                    "Apply to more works and unlock premium features.",
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _featureRow(
            LucideIcons.check,
            "${plan['max_count'] == 0 ? 'Unlimited' : plan['max_count']} Applications",
          ),
          _featureRow(LucideIcons.check, "Priority Skill Badge"),
          _featureRow(LucideIcons.check, "Pro Chat access"),
          const SizedBox(height: 24),
          SizedBox(
