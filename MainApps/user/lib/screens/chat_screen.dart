        ...
        actions: [
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              ...
              PopupMenuItem(
                value: 'report',
                child: Text("Report Project", style: GoogleFonts.poppins()),
              ),
            ],
          ),
        ],
    ...
    try {
      ...
      if (res == true) {
        await supabase
            .from('tbl_chat')
            .delete()
            .eq('from_userid', currentUserId!)
            .eq('to_clientid', widget.receiverId);
        await supabase
            .from('tbl_chat')
            .delete()
            .eq('to_userid', currentUserId!)
            .eq('from_clientid', widget.receiverId);
      }
    } catch (_) {}
  }
